...
export default function OrderSuccess() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar />
      <main className="flex-grow bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
                ...
                <div className="space-y-3">
                  ...
                  {paymentData?.method && (
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold capitalize text-gray-900 dark:text-white">{paymentData.method}</span>
                    </div>
                  )}
                  {paymentData?.paymentIntentId && (
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Transaction ID:</span>
                      <span className="font-mono text-sm text-gray-900 dark:text-white">{paymentData.paymentIntentId}</span>
                    </div>
                  )}
                  {paymentData?.amount && (
                    <div className="flex justify-between items-center pt-3 border-t border-gray-200 dark:border-gray-600">
                      <span className="text-gray-600 dark:text-gray-300">Amount Paid:</span>
                      <span className="font-bold text-lg text-gray-900 dark:text-white">${paymentData.amount.toFixed(2)}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-8">
                <h3 className="font-semibold text-blue-800 dark:text-blue-200 mb-4">What's Next?</h3>
                <div className="space-y-3 text-left">
                  <div className="flex items-start">
                    <Mail className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-3 mt-0.5" />
                    <div>
                      <div className="font-medium text-blue-900 dark:text-blue-100">Confirmation Email</div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="font-medium text-blue-900 dark:text-blue-100">Order Processing</div>
                      <div className="text-sm text-blue-700 dark:text-blue-300">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  onClick={() => navigate('/')}
                  className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-6 py-3 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 font-semibold flex items-center justify-center"
                >
